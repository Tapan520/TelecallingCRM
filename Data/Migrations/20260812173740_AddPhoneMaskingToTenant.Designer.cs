...
namespace TelecallingCRM.Data.Migrations
{
    ...
    [Migration("20260812173740_AddPhoneMaskingToTenant")]
    partial class AddPhoneMaskingToTenant
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.AgentBadge", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.Announcement", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.AnnouncementRead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.AttendanceLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid>("PunchedInById")
                        .HasColumnType("char(36)");

                    b.Property<Guid?>("PunchedOutById")
                        .HasColumnType("char(36)");
                    ...
                    b.HasIndex("PunchedInById");

                    b.HasIndex("PunchedOutById");

                    b.HasIndex("AgentId", "PunchIn");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.CallQualityScore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.Expense", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.Holiday", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.LeaveBalance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<int>("CasualLeaveTotal")
                        .HasColumnType("int");

                    b.Property<int>("CasualLeaveUsed")
                        .HasColumnType("int");

                    b.Property<int>("CompOffTotal")
                        .HasColumnType("int");

                    b.Property<int>("CompOffUsed")
                        .HasColumnType("int");

                    b.Property<int>("EarnedLeaveTotal")
                        .HasColumnType("int");

                    b.Property<int>("EarnedLeaveUsed")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "AgentId", "Year")
                        .IsUnique();

                    b.ToTable("LeaveBalances");
                });

            modelBuilder.Entity("TelecallingCRM.Data.Models.LeaveRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.OnboardingChecklist", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.ShiftSwapRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid?>("SwapWithAgentId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.Tenant", b =>
                {
                    ...
                    b.Property<bool>("PhoneMaskingEnabled")
                        .HasColumnType("tinyint(1)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.TenantModuleAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("TenantModuleAccess");
                });

            modelBuilder.Entity("TelecallingCRM.Data.Models.UserActivityLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.WorkModeLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.AnnouncementRead", b =>
                {
                    b.HasOne("TelecallingCRM.Data.Models.Announcement", "Announcement")
                        .WithMany("Reads")
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.AttendanceLog", b =>
                {
                    ...
                    b.HasOne("TelecallingCRM.Data.Models.AppUser", "PunchedInBy")
                        .WithMany()
                        .HasForeignKey("PunchedInById")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("TelecallingCRM.Data.Models.AppUser", "PunchedOutBy")
                        .WithMany()
                        .HasForeignKey("PunchedOutById")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("PunchedInBy");

                    b.Navigation("PunchedOutBy");
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.CallQualityScore", b =>
                {
                    ...
                    b.HasOne("TelecallingCRM.Data.Models.AppUser", "ReviewedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("TelecallingCRM.Data.Models.ShiftSwapRequest", b =>
                {
                    b.HasOne("TelecallingCRM.Data.Models.AppUser", "RequestedBy")
                        .WithMany()
                    ...
                    b.HasOne("TelecallingCRM.Data.Models.AppUser", "SwapWithAgent")
                        .WithMany()
                        .HasForeignKey("SwapWithAgentId")
                        .OnDelete(DeleteBehavior.Restrict);
