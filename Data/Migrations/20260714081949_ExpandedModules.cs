...
{
    /// <inheritdoc />
    public partial class ExpandedModules : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FollowUps_AspNetUsers_AssignedToId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeadDocuments_AspNetUsers_UploadedById",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeadDocuments_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityLogs_LeadId_OccurredAt",
                table: "ActivityLogs",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowUps_AssignedToId_ScheduledAt",
                table: "FollowUps",
                columns: new[] { "AssignedToId", "ScheduledAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FollowUps_TenantId_Status",
                table: "FollowUps",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeadDocuments_TenantId",
                table: "LeadDocuments",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_LeadDocuments_UploadedById",
                table: "LeadDocuments",
                column: "UploadedById");
