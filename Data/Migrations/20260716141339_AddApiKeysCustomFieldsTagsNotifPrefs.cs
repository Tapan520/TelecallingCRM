...
{
    /// <inheritdoc />
    public partial class AddApiKeysCustomFieldsTagsNotifPrefs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomLeadFields", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomLeadFields_Tenants_TenantId",
                        column: x => x.TenantId,
                        principalTable: "Tenants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomLeadFields_TenantId",
                table: "CustomLeadFields",
                column: "TenantId");

            migrationBuilder.CreateIndex(
                name: "IX_LeadTags_TenantId_Name",
                table: "LeadTags",
